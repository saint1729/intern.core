...
<script type="text/javascript">
	...
	if(phi_1<8 || phi_1>25 || (phi_2<8&&phi_2!=0) || phi_2>25)
		{
			alert('Value of diameter should be between 8 and 25');
			z = 0;
		}
	if (x==1 && y==1 && z==1)
		{
			...
			if(document.getElementById('Fe250').checked) {
				...
				var Muc = K*f_ck*b*d*d*Math.pow(10,-6);
				var R  = (0.87*f_y*pst/100.0)*(1.0-1.005*(f_y/f_ck)*pst/100.0);
				var Mus = R*b*d*d*Math.pow(10,-6);
